    ...
    <div className="modern-listing-container">
      {loading ? (
                ...
                return (
                  ...
                  >
                    ...
                    <div className="modern-listing-info">
                      <h3 className="modern-listing-title">{service.title || "Untitled Service"}</h3>
                      <p className="modern-listing-location">{service.location || "No location info"}</p>
                      <p className="modern-listing-price">
                        ₱{service.price || "0"} <span className="modern-price-label">per service</span>
                      </p>
                    </div>
                  </div>
                );
        ...
        <div className="modern-empty-state">
          <p className="modern-empty-text">No Service listings found.</p>
        </div>
      )}
    </div>
  );
