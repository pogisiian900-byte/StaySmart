...
import { collection, onSnapshot, orderBy, query, updateDoc, where, doc, serverTimestamp } from 'firebase/firestore'
          ...
          <div className="modal" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="modal-footer" style={{ justifyContent:'space-between' }}>
              ...
              <div style={{ display:'flex', gap:8 }}>
                <button className="btn btn-primary" disabled={updating===selectedReservation.id || selectedReservation.status!=='pending'} onClick={() => handleDecision(selectedReservation.id, 'confirmed')}>Confirm</button>
